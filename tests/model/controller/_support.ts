...
import type { RunId, RunState, StateStore, StepEntry } from '../../../src/state/index.ts'
...
export function makeStep(overrides: Partial<StepEntry> & Pick<StepEntry, 'name'>): StepEntry {
  return {
    name: overrides.name,
