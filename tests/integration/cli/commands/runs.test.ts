// MIGRATED → tests-new/integration/cli/commands/runs.test.ts (parent U13) — relocated verbatim (import paths only); kept skipped on disk (D2).
...
describe.skip('runsCmd (integration)', () => {
