// MIGRATED → tests-new/integration/real-tmux/wheel-no-mode-error.test.ts
...
describe.skip('Tier 1 — smart-wheel binding structurally prevents the `not in a mode` regression', () => {
