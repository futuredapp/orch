// MIGRATED → tests-new/integration/real-tmux/steps-view-header-no-duplicate.test.ts
...
describe.skip('left-pane steps-view header does not duplicate on state changes + resizes', () => {
  it('renders the run breadcrumb exactly once after several state changes and pane resizes', async () => {
