// MIGRATED → tests-new/unit/core/types-step-name-pattern.test.ts (parent U10) — relocated verbatim (import paths only); kept skipped on disk (D2).
...
describe.skip('stepName — widened pattern', () => {
...
describe.skip('stepName — length bound at 512', () => {
