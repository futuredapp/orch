...
function classify(relPath: string): { classification: Classification; rule: string } {
  ...
  if (relPath.startsWith('tests/helpers/')) return { classification: 'helper', rule: 'dir:tests/helpers' }
  if (relPath.startsWith('tests/fixtures/')) {
    return { classification: 'fixture', rule: 'dir:tests/fixtures' }
  }
  if (relPath.startsWith('tests/setup/')) return { classification: 'setup', rule: 'dir:tests/setup' }
